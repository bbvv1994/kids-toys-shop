  ...
  return (
    <Box
      ...
      sx={{
        ...
        cursor: 'pointer',
        height: '100%',
        width: viewMode === 'similar' && isMobile ? '167px' : '260px',
        minWidth: viewMode === 'similar' && isMobile ? '167px' : '260px',
        maxWidth: viewMode === 'similar' && isMobile ? '167px' : '260px',
        display: 'flex',
        flexDirection: 'column',
        isolation: 'isolate',
        zIndex: isHovered ? 10 : 1,
    ...
    >
      {(user && onWishlistToggle) && (
        <Box
          sx={{
            position: 'absolute',
            bottom: viewMode === 'similar' && isMobile ? 146 : (isMobile ? 180 : 243),
            right: isMobile ? 8 : 12,
            zIndex: 9999,
      ...
      <Box sx={{ 
        position: 'relative', 
        width: '100%', 
        height: viewMode === 'similar' && isMobile ? 126 : (isMobile ? 160 : 200), 
        overflow: 'hidden', 
